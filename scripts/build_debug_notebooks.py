...
def build_c1_cells(mb, target, run_id):
    ...
    return [
        ...
        code(
            ...
            "    print('salto entre bins contiguos, en unidades del error formal del ajuste:')\n"
            "    for n in NOMBRES:\n"
            "        _d = np.abs(np.diff(_v[n]))\n"
            "        with np.errstate(invalid='ignore', divide='ignore'):\n"
            "            _r = np.nanmedian(_d / np.maximum(_e[n][1:], 1e-30))\n"
            "        print(f'   {n:6s} x{_r:6.1f}')\n"
            "    print()\n"
