...
def build_a3_cells(mb, target, run_id):
    ...
    cells = [
        ...
        md(
            "### 14.2 · La prueba: corregir con cada una y medir lo que queda\n\n"
        ...
        code(
            ...
            "        if t is not None:\n"
            "            m = (r > 0) & (t > 0)\n"
            "            corr[m] = s[m] / t[m]     # fuera de los rangos ajustados no hay T\n"
            ...
            "    w_cmb, s_cmb = _espectro_de('combinado')\n"
            "    t, r = _c.get('mtrans_combinado'), _c.get('mrange_combinado')\n"
            "    esp_comb = s_cmb.copy()\n"
            "    if t is not None:\n"
            "        m = (r > 0) & (t > 0)\n"
            "        esp_comb[m] = s_cmb[m] / t[m]\n\n"
        ...
        md(
            "### 14.3 · Cómo se lee, y qué NO decide esto\n\n"
