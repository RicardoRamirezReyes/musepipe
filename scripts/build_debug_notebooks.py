...
def build_c3_cells(mb, target, run_id):
    ...
    return [
        ...
        code(
            ...
            "fig.suptitle(f'λ = {WAVE[iz2]:.0f} Å · × roja = píxel recortado por el σ-clipping',\n"
            "             fontsize=9)\n"
            "fig.tight_layout(); plt.show()\n\n"
            ...
            "ax.set_xlabel('distancia al compañero [px]')\n"
            "ax.set_ylabel(f'flujo [{UNIDAD}]')\n"
            "ax.set_title(f'perfil radial en la ventana (λ = {WAVE[iz2]:.0f} Å)', fontsize=9)\n"
