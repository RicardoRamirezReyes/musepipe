...
def build_c1_cells(mb, target, run_id):
    ...
    return [
        ...
        code(
            ...
            "_i = int(np.nanargmax(_salto))\n"
            "print()\n"
            "print(f'mayor salto de `{NOMBRES[0]}` entre dos canales contiguos:')\n"
            "print(f'   λ={WAVE_ALL[_i]:.1f} Å -> w_eff {W_EFF[_i]:.0f}, {NOMBRES[0]} = {_r0[_i]:.10g}')\n"
            "print(f'   λ={WAVE_ALL[_i+1]:.1f} Å -> w_eff {W_EFF[_i+1]:.0f}, {NOMBRES[0]} = {_r0[_i+1]:.10g}')\n"
            "print(f'   salto = {100 * _salto[_i]:.2f} % en {WAVE_ALL[_i+1] - WAVE_ALL[_i]:.2f} Å'\n"
        ...
        code(
            ...
            "    _lo, _hi = WAVE_ALL[_i] - 150, WAVE_ALL[_i] + 150\n"
