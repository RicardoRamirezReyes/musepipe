...
def build_a3_cells(mb, target, run_id):
    ...
    cells = [
        ...
        md(
            ...
            "de MUSE al lado como referencia. Un `gauss` pegado a **0** no es una medida: es un "
            "parámetro contra su tope, absorbiendo lo que no se está modelando."
        ),
        code(
            "def _datos_molecfit(etq):\n"
            "    \"\"\"(lambda, dato normalizado, modelo, rango) del producto de molecfit.\n\n"
            ...
            "        d = h[1].data\n"
            "        lam = np.asarray(d['lambda'], dtype=np.float64) * 1e4   # micras -> A\n"
