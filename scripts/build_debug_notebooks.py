...
def build_c1_cells(mb, target, run_id):
    ...
    return [
        ...
        code(
            ...
            "            if len(_disco) > MAS_CACHES:   # se van las más viejas\n"
            "                _disco = dict(sorted(_disco.items(),\n"
            "                                     key=lambda kv: -kv[1].get('ts', 0))[:MAS_CACHES])\n"
            "            CACHE_MAPA.write_text(json.dumps(\n"
            "                {'version': 2, 'entradas': _disco},\n"
