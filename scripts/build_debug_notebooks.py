...
def build_c2_cells(mb, target, run_id):
    ...
    cells = [
        ...
        code(
            ...
            "a1.set_title('campo, escala log: manda el halo (el compañero no se ve)', fontsize=9)\n"
        ...
        code(
            ...
            "    b1.set_title('dato (mediana en λ)', fontsize=9)\n"
        ...
        md(
            ...
            "### Qué es `apcorr`\n\n"
            "Una caja 3×3 no recoge toda la luz de una fuente puntual: en NFM recoge **~2%**. "
            "`apcorr(λ)` es el factor que convierte «lo que hay en la caja» en «el flujo total de "
            "la fuente», y por eso vale ~45.\n\n"
        ...
        code(
            ...
            "ax.set_xlabel('λ [Å]'); ax.set_ylabel('apcorr')\n"
            "ax.set_title('corrección de apertura vs λ: sube al azul porque la PSF se ensancha', fontsize=9)\n"
            "fig.tight_layout(); plt.show()"
        ),
        md(
