...
def build_a3_cells(mb, target, run_id):
    ...
    cells = [
        ...
        md(
            "### 14.2 · Cada observación corregida, y el combinado\n\n"
            ...
            "dentro de la banda, antes y después. Es una medida distinta de la de §14.3 — allí "
        ...
        md(
            "### 14.3 · La prueba: corregir con cada una y medir lo que queda\n\n"
        ...
        md(
            "### 14.4 · Cómo se lee, y qué NO decide esto\n\n"
