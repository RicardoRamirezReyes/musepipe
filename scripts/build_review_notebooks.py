        ...
        plots=[
            dict(
                md=(
                    ...
                    "Continuos del **par que gatea v3**, crudos vs referenciados a sus controles. El par "
                    "no es fijo: lo elige D1/D2 y lo declara el QC — para este objeto es "
                    ...
                    "Los dos métodos comparten un pedestal de halo sin fuente, así que comparar los "
                    "continuos **crudos** lo cuenta dos veces; por eso v3 gatea sobre la métrica "
                    "**referenciada**. Concordancia de canales para este objeto: "
                    ...
                    "(referenciada), con el umbral en "
                    "{{qc:stages/stage_x11_qc.json:checks.v3_continuum_stable.threshold}}. Referenciar "
                    "**no siempre sube** la métrica: acerca los continuos donde el pedestal era común, y "
                    "si el residuo cromático no es común puede bajarla — eso también es información.\n\n"
                ...
                code=(
                    ...
                    "        ax.set_title(f'{title} (concuerdan {frac:.3f})')\n"
                    "    for ax in (axl, axr):\n"
                    ...
                    "    fig.suptitle(f\"D2 · referenciación a controles: el par que gatea v3 ({pair[0]} vs {pair[1]})\")\n"
                    "    fig.tight_layout()\n"
