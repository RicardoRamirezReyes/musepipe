        ...
        plots=[
            dict(
                md=(
                    ...
                    "**Columna izquierda — `continuo − offset`.** En gris lo que hay en la apertura "
                    ...
                    "puede comparar con la del método. Ahí se ve, por ejemplo, que la subida al rojo "
                    "del continuo de `psffit` sigue la forma del propio halo. El eje es symlog porque "
                    "el residuo cruza el cero.\n\n"
                    "*(El offset es solo del dibujo: las cifras de la derecha usan la referencia "
                    "entera, o dejarían de ser «% de lo que había».)*\n\n"
